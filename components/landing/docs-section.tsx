...
export default function DocsSection() {
  return (
    <section id="docs" className="relative py-16 md:py-24 border-t border-gray-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-400 mt-4">
            VeriCred is a cutting-edge platform revolutionizing academic and professional credentialing. It leverages
            blockchain technology (NFTs on Polygon) for secure, transparent, and instantly verifiable digital records of
            achievements, empowering individuals and streamlining processes for institutions and verifiers.
          </p>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                ...
                icon: Code,
                items: ["Solidity", "ERC-721", "IssuerRegistry", "RevocationRegistry"],
              },
              {
                title: "Backend",
                icon: Database,
