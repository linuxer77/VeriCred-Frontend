    ...
    try {
      ...
      if (!localStorage.getItem("vericred_wallet")) {
        localStorage.setItem(
          "vericred_wallet",
          JSON.stringify({ address: "0xDEMO000000000000000000000000000000000000" }),
        )
      }
      ...
      const res = await fetch(mode === "university" ? "http://localhost:8080/api/create/org" : "http://localhost:8080/api/create/user", {
        method: "POST",
        headers: {
      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            exit={{ y: 30, scale: 0.9, opacity: 0, transition: { duration: 0.2 } }}
          ...
          >
            ...
            <form onSubmit={submit} className="relative z-10 flex flex-col gap-6 p-5 sm:p-7">
              <div className="space-y-2">
                <h2 className="text-2xl font-semibold text-white-primary flex items-center gap-2">
                  {mode === "student" ? "Student" : "University"} Demo Verification
                </h2>
                <p className="text-xs text-white-primary/60 leading-relaxed">
                  Demo notice: No real identity or university verification happens yet. Anyone may sign up as a student or
                  university. Full document & institutional validation will be added later.
                </p>
                {error && (
                  <div className="text-xs text-red-300 bg-red-900/20 border border-red-800 rounded px-3 py-2">{error}</div>
                )}
              </div>
              ...
              {mode === "student" && (
                <div className="grid gap-4 max-h-[65vh] sm:max-h-[72vh] overflow-y-auto pr-1">
                  <div className="space-y-1">
                    <label className="text-[11px] font-medium text-white-primary/70">Email</label>
                    <input
                      ref={firstFieldRef}
                      required
                      type="email"
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <div className="flex-1 space-y-1">
                      <label className="text-[11px] font-medium text-white-primary/70">First name</label>
                      <input
                        required
                    ...
                    <div className="flex-1 space-y-1">
                      <label className="text-[11px] font-medium text-white-primary/70">Last name</label>
                      <input
                        required
                        value={form.lastName}
                  ...
                  <div className="space-y-1">
                    <label className="text-[11px] font-medium text-white-primary/70">Student email (institutional)</label>
                    <input
                      required
                      type="email"
              ...
              {mode === "university" && (
                <div className="grid gap-4 max-h-[65vh] sm:max-h-[72vh] overflow-y-auto pr-1">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-white-primary/70">Academic Email</label>
                      <input
                        ref={firstFieldRef}
                        required
                        type="email"
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-white-primary/70">University Name</label>
                      <input
                        required
                        value={form.OrgName}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-white-primary/70">University Type</label>
                      <input
                        required
                        value={form.OrgType}
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-white-primary/70">University Website</label>
                      <input
                        type="url"
                        value={form.OrgUrl}
                  ...
                  <div className="space-y-1">
                    <label className="text-[11px] font-medium text-white-primary/70">University Description</label>
                    <textarea
                      value={form.OrgDesc}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-white-primary/70">Country</label>
                      <input
                        value={form.Country}
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-white-primary/70">State</label>
                      <input
                        value={form.State}
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-white-primary/70">City</label>
                      <input
                        value={form.City}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="sm:col-span-2 space-y-1">
                      <label className="text-[11px] font-medium text-white-primary/70">Address</label>
                      <input
                        value={form.Address}
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-white-primary/70">PostalCode</label>
                      <input
                  ...
                  <div className="space-y-1">
                    <label className="text-[11px] font-medium text-white-primary/70">Total Students</label>
                    <input
                      type="number"
                      min={0}
              ...
              <div className="flex items-center justify-between">
                <span className="text-[10px] text-white-primary/40">Press Enter to continue • Demo only</span>
                <button
                  type="submit"
                ...
                >
                  <span className="relative flex items-center gap-2">
                    ...
                    {done ? "Completed" : submitting ? "Processing..." : "Complete demo signup"}
                  </span>
                  <motion.span
...
export default function VerificationHub() {
  ...
  const [signupMode, setSignupMode] = useState<"student" | "university">("student")
  ...
  return (
    <div className="grid grid-cols-1 gap-4">
      ...
      {/* Modal mount */}
      <VerificationSignupModal open={signupOpen} mode={signupMode} onClose={() => setSignupOpen(false)} />
    </div>
  )
}
