...
export default function CredentialDetails() {
  ...
  useEffect(() => {
    const mockData: CredentialData = {
      ...
      external_url: "ipfs://QmYourCredentialDetailsHash/bs_cs_program_details.pdf",
      attributes: [
        { trait_type: "Credential Type", value: "Bachelor's Degree" },
        { trait_type: "Issuing Institution", value: "Example University" },
        { trait_type: "Issuer Wallet", value: "0xUniversityOfficialWalletAddress12345" },
        { trait_type: "Recipient Name", value: "John Doe" },
        { trait_type: "Recipient Wallet", value: "0xStudentWalletAddressABCDEF" },
        ...
        { trait_type: "Verification URL", value: "https://vericred.com/verify?credentialId=EXU-CS-BS-12345-2024" },
        { trait_type: "Accreditation Body", value: "Accreditation Council for Education (ACE)" },
        { trait_type: "Program Details", value: "ipfs://QmProgramDetailsHash/bs_cs_curriculum.json" },
      ],
      animation_url: null,
      youtube_url: null,
  ...
  const getAttributeValue = (traitType: string) => {
    return credentialData?.attributes.find((attr) => attr.trait_type === traitType)?.value || "N/A"
  }
    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <Card className="w-full max-w-md bg-gray-900 border-gray-800">
          ...
          <CardContent>
            <p className="text-center text-gray-400 mb-4">The requested credential could not be loaded.</p>
            <Button
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      >
        <div className="flex items-center gap-2 text-sm text-gray-400">
          ...
          <span className="hover:text-white cursor-pointer">{getAttributeValue("Issuing Institution")}</span>
          <ChevronRight className="h-4 w-4" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <Card className="bg-gray-900 border-gray-800">
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <h3 className="font-semibold text-white">{getAttributeValue("Issuing Institution")}</h3>
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">{credentialData.name}</h1>
                <p className="text-lg text-gray-300 leading-relaxed">{credentialData.description}</p>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-white">{getAttributeValue("Recipient Name")}</span>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-sm text-gray-400 mb-1">Issued</p>
                    <p className="font-medium text-white">{getAttributeValue("Issue Date")}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button
                  ...
                  onClick={() => window.open(getAttributeValue("Verification URL"), "_blank")}
                >
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="details" className="space-y-4 mt-6">
                <Card className="bg-gray-900 border-gray-800">
                  ...
                  <CardContent>
                    <p className="text-gray-300 leading-relaxed">{credentialData.description}</p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-gray-900 border-gray-800">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-mono text-sm">{getAttributeValue("Credential ID")}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    >
                      <Card className="bg-gray-900 border-gray-800 hover:border-gray-700 transition-colors">
                        <CardContent className="p-3 text-center">
                          ...
                          <p className="text-xs text-gray-400 mb-1">{attribute.trait_type}</p>
                          <p className="font-medium text-white text-sm truncate">
                            {attribute.trait_type.includes("Wallet") ? formatAddress(attribute.value) : attribute.value}
                          </p>
                          <p className="text-xs text-gray-500 mt-1">
                            {Math.floor(Math.random() * 20 + 5)}% have this trait
                          </p>
                        </CardContent>
                      </Card>
                    </motion.div>
              ...
              <TabsContent value="activity" className="mt-6">
                <Card className="bg-gray-900 border-gray-800">
                  <CardContent className="p-4">
                    <div className="space-y-4">
                      {[
                        { action: "Minted", user: "Example University", time: "2 days ago", icon: Award },
                        { action: "Verified", user: "VeriCred System", time: "2 days ago", icon: Shield },
                        { action: "Viewed", user: "Anonymous", time: "1 hour ago", icon: Eye },
                      ].map((activity, index) => (
                        <motion.div
                          key={index}
